> This is an STM32F103x6 Baremetal Software to test My 7-SEGMENT-DISPLAY DRIVER.
> The APIs included in the 7SEGMENT_DRIVER are :
	#	SEVEN_SEGMENT_Pin_a_Init
	#	SEVEN_SEGMENT_Pin_b_Init
	#	SEVEN_SEGMENT_Pin_c_Init
	#	SEVEN_SEGMENT_Pin_d_Init
	#	SEVEN_SEGMENT_Pin_e_Init
	#	SEVEN_SEGMENT_Pin_f_Init
	#	SEVEN_SEGMENT_Pin_g_Init
